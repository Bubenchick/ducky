<!-- Явное разделение между карточками и таблицей потому что лучше разделить их, чем мучать компонент карточки перестроением -->
<!-- Если подумать что будет дальше со страницей, то возможно стоит разделить на разные лэйауты, но пока в целом ок -->
<!-- Виртуализация если большие списки -->
<!-- Добавить лейзи лоад -->
<template>
